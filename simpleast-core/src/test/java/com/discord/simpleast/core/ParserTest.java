...
public class ParserTest {
    ...
    private Parser<SpannableRenderableNode<Object>> parser;
    ...
    public void testEmptyParse() throws Exception {
        final List<SpannableRenderableNode<Object>> ast = parser.parse("");
        Assert.assertTrue(ast.isEmpty());
    }

    @Test
    public void testParseFormattedText() throws Exception {
        final List<SpannableRenderableNode<Object>> ast = parser.parse("**bold**");
    ...
    public void testParseLeadingFormatting() throws Exception {
        final List<SpannableRenderableNode<Object>> ast = parser.parse("**bold** and not bold");
    ...
    public void testParseTrailingFormatting() throws Exception {
        final List<SpannableRenderableNode<Object>> ast = parser.parse("not bold **and bold**");
...
//        final List<SpannableRenderableNode> ast = parser.parse("*** test1 ** test2 * test3 * test4 ** test5 ***");
        final List<SpannableRenderableNode<Object>> ast = parser.parse("**bold *and italics* and more bold**");
